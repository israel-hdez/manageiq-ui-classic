...
function MwAddDatasourceService($http, $q) {
  ...
  var datasources = [
    ...
    {id: 'DB2', label: 'IBM DB2', name: 'DB2DS', jndiName: 'java:jboss/datasources/DB2DS',
      driverName: 'ibmdb2', driverModuleName: 'com.ibm', driverClass: 'com.ibm.db2.jcc.DB2Driver',
      connectionUrl: '://db2'},
    {id: 'SYBASE', label: 'Sybase', name: 'SybaseDS', jndiName: 'java:jboss/datasources/SybaseDB',
      driverName: 'sybase', driverModuleName: 'com.sybase', driverClass: 'com.sybase.jdbc4.jdbc.SybDriver',
  ...
  var xaDatasources = [
    ...
    {id: 'DB2', label: 'IBM DB2 XA', name: 'DB2XADS',
      ...
      driverClass: 'com.ibm.db2.jcc.DB2XADataSource',
      properties: {
